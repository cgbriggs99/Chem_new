...
template<typename _T, typename _Alloc>
const _T &compchem::Matrix<_T, _Alloc>::getEntry(int index, ...) const {
	int offset = index;
	va_list list;
	va_start(list, index);
...
template<typename _T, typename _Alloc>
const _T &compchem::Matrix<_T, _Alloc>::getEntry(std::vector<int> index) const {
...
template<typename _T, typename _Alloc>
void compchem::Matrix<_T, _Alloc>::setEntry(const _T &ent, int index, ...) {
	int offset = index;
	va_list list;
	va_start(list, index);
